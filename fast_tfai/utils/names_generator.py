...
"""
Module to generate docker-style names for models
"""
import random
...
right = [
    # Niels Henrik Abel, mathematician https://en.wikipedia.org/wiki/Niels_Henrik_Abel
    "abel",
    ...
    "lamport",
    # Emanuel Lasker - Chess World Champion https://en.wikipedia.org/wiki/Emanuel_Lasker
    "lasker",
...
def get_random_name(sep="_") -> str:
    """Generate random docker-style name.

    Args:
        sep (str, optional): separator between left and right part. Defaults to "_".

    Returns:
        str: the docker-style name.
    """
